...
class Reinforce(tf.keras.Model):
    ...
    def loss(self, states, actions, discounted_rewards):
        ...
        prbs = tf.gather_nd(self.call(states),tf.convert_to_tensor(list(enumerate(actions))))
        weighted = tf.math.multiply(-tf.math.log(prbs),discounted_rewards)
        return tf.math.reduce_sum(weighted)
